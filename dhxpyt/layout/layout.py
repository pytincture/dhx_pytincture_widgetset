...
from ..menu.menu_config import MenuConfig
...
class Layout:
    ...
    def add_menu(self, id: str = "mainwindow_header", menu_config: MenuConfig = None) -> Menu:
        ...
        self.layout.getCell(id).attach(menu_widget.menu)
        return menu_widget

    def add_toolbar(self, id: str = "mainwindow", toolbar_config: Dict[str, Any] = {}) -> Toolbar:
